          ...
          <div id="slider-carousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
              <div class="item active">
                ...
                <div class="col-sm-6">
                  <img src="{{URL::To('images/home/girl1.jpg')}}" class="girl img-responsive" alt="" />
              ...
              <div class="item">
                ...
                <div class="col-sm-6">
                  <img src="{{URL::To('images/home/girl2.jpg')}}" class="girl img-responsive" alt="" />
                  <img src="{{URL::To('images/home/pricing.png')}}"  class="pricing" alt="" />
                </div>
              </div>
              ...
              <div class="item">
                ...
                <div class="col-sm-6">
                  <img src="{{URL::To('images/home/girl3.jpg')}}" class="girl img-responsive" alt="" />
                  <img src="{{URL::To('images/home/pricing.png')}}" class="pricing" alt="" />
                </div>
              </div>
